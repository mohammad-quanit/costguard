...
**Request:**
```bash
curl -X GET https://v49jjlxhmc.execute-api.us-east-1.amazonaws.com/dev/budget \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
...
**Request:**
```bash
curl -X GET "https://v49jjlxhmc.execute-api.us-east-1.amazonaws.com/dev/budget?budgetId=a10ba90d-48de-4258-9e7b-9480dfd7617e" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
...
**Request:**
```bash
curl -X GET "https://v49jjlxhmc.execute-api.us-east-1.amazonaws.com/dev/budget?primaryOnly=true" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
...
BUDGET_ID="a10ba90d-48de-4258-9e7b-9480dfd7617e"
curl -X GET "https://v49jjlxhmc.execute-api.us-east-1.amazonaws.com/dev/budget?budgetId=$BUDGET_ID" \
  -H "Authorization: Bearer $ACCESS_TOKEN" | \
  jq '.budgets[0] | {
    name: .budgetName,
    limit: .monthlyLimit,
