...
**Request:**
```bash
curl -X POST https://dl6q0k9s90.execute-api.us-east-1.amazonaws.com/dev/auth/signin \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "password": "SecurePass123!"
...
**Request:**
```bash
curl -X POST https://dl6q0k9s90.execute-api.us-east-1.amazonaws.com/dev/auth/refresh \
  -H "Content-Type: application/json" \
  -d '{
    "refreshToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
  }'
...
```bash
curl -X GET https://dl6q0k9s90.execute-api.us-east-1.amazonaws.com/dev/auth/profile \
