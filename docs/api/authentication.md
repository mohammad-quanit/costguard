...
**Request:**
```bash
curl -X POST https://xlr4wiih1g.execute-api.us-east-1.amazonaws.com/local/auth/signup \
...
**Request:**
```bash
curl -X POST https://xlr4wiih1g.execute-api.us-east-1.amazonaws.com/local/auth/signin \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "password": "SecurePass123!"
...
**Request:**
```bash
curl -X POST https://xlr4wiih1g.execute-api.us-east-1.amazonaws.com/local/auth/refresh \
  -H "Content-Type: application/json" \
  -d '{
    "refreshToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
  }'
...
```bash
curl -X GET https://xlr4wiih1g.execute-api.us-east-1.amazonaws.com/local/auth/profile \
